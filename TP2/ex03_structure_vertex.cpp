...
int main(int /*argc*/, char** argv)
{
	...
	Vertex2DColor vertices[] = { 
		...
		Vertex2DColor(glm::vec2(0, 0.5), glm::vec3(0, 0, 1))      // Troisième sommet
	};

	// Remplissage du VBO, on envoie les données des vertices
	glBufferData(
		GL_ARRAY_BUFFER, // La cible ou le VBO est bindé
		3 * sizeof(Vertex2DColor), // La taille du tableau en **octets** (3 point dont les données sont 3 Vertex2DColor)
